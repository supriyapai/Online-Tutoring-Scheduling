...
<?php
            ...
            $pass = $_SESSION["password"];//computing MD5 of the password provided by the user
            ...
            $E=$username;
           /*  print_r($username2);
            echo "<br>".$username2['SemRefreshAccess']."</br>";
            echo "<br>".$user."</br>"; */
...
<div class="menu">
	...
	<form id = "myForm" name = "myForm" action = "Allocate_entry.php" onsubmit="return validateForm()" method = "post">
		<br>
	...
	?>
		...
		<center> <button type="submit" name="Submit"><img src="../images/save.png"  width="102" height="28" border="none"/></a></button></center>
		  <div class = "mesg1"><span width='100px'><center><?php if(!empty($A)) echo "$A";?></center></span></div>
		  <div class = "mesg2">  <?php if(!empty($B)) echo "$B" ;?> </div>
		</br>
	</form>

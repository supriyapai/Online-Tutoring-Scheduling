...
<div id="container">
    <div class="menu">
         <ul>
             ...
             <li><a class="hide" href="">EDIT</a>
                 <ul>
					...
					s(Session Schedule to Edit Single Session & Edit Multiple Session) -->
					<ul>
        ...
        <div id="text2"><p>Please select your delete option for Student</p></div>
 ...
 <br><br><br> 
   ...
   <div class = "back">
		...
		<br>
        <div id="cancel">
        <a href="deletestu_status.php"><img src="../images/DelByStatus.png"  width="145" height="28" border="none"/></a>
	</div>
        <br>
        <div id="reschedule">
        <a href="delete_stuyear.php"><img src="../images/DelByGYR.png"  width="145" height="28" border="none"/></a>
	</div>
	    <br>
	<div id="mainpage2">
        <a href="delete_student.php"><img src="../images/DelByName.png"  width="145" height="28" border="none"/></a>

...
<div class="menu">
	...
	<div id="text2"><p>Please select your delete option for Tutor</p></div>
   ...
   <div class = "back">
		...
		<br>
        <div id="cancel">
        <a href="deletetut_status.php"><img src="../images/DelByStatus.png"  width="145" height="28" border="none"/></a>
	</div>
        <br>
        <div id="reschedule">
        <a href="delete_tutyear.php"><img src="../images/DelByGYR.png"  width="145" height="28" border="none"/></a>
	</div>
	    <br>
	<div id="mainpage2">
        <a href="delete_tutor.php"><img src="../images/DelByName.png"  width="145" height="28" border="none"/></a>

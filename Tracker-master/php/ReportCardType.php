<!-- this page displays Reports based on the Session Type -->
...
<?php
	...
	$sessionTypeSel = $_POST["sessiontype"];
	$type = $_POST["sessionsubtype"];
	$sort = $_POST["sort"];
...
*/
	...
	$filename='SessionTypeReport_'.$file_app_from_date.'.csv'; 
...
/* Shyam Joshi End of code change September 14,2016 */	
	...
	//$fp=fopen($_SERVER['DOCUMENT_ROOT'].'/csv/' .$filename,"w");
	if($Sname == '---SELECT---'){
		...
		//Previous Code
		//$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Student_Type='$type' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		//Modified By Kishan
		if($sessionTypeSel=="Reg"){
			if($type=="select"){
				$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
			}
			else{
				$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='' AND (Student_Type='$type' OR Tutor_Type='$type') AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
			}
		}elseif ($sessionTypeSel=="select"){
			if($type=="select"){
				$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
			}else{
				$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE (Student_Type='$type' OR Tutor_Type='$type') AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		  }      
		}else{
			if($type=="select"){
				$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='$sessionTypeSel' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
			}else{
				$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='$sessionTypeSel' AND (Student_Type='$type' OR Tutor_Type='$type') AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
			}
			}
      }
      elseif($Sname == '')
      {
		//Previous Code
		//$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		//Modified By Kishan
		if($sessionTypeSel=="Reg"){
		  if($type=="select"){
			$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Session_Type='' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		  }else{
			$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Session_Type='' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		  }
		}elseif ($sessionTypeSel=="select"){
		  if($type=="select"){
		...
		if($type=="select"){
			$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Session_Type='$sessionTypeSel' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		}else{
			$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Session_Type='$sessionTypeSel' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		}
	}
	}elseif($Tname == ''){
	//Previous Code
	//$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Student_Poly_Id='$Sname' AND Student_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
	//Modified By Kishan
          if($sessionTypeSel=="Reg"){
              if($type=="select"){
                $session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Student_Poly_Id='$Sname' AND Session_Type='' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                $session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Student_Poly_Id='$Sname' AND Session_Type='' AND Student_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }
          }elseif ($sessionTypeSel=="select"){
              if($type=="select"){
              ...
              if($type=="select"){
                $session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Student_Poly_Id='$Sname' AND Session_Type='$sessionTypeSel' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                $session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Student_Poly_Id='$Sname' AND Session_Type='$sessionTypeSel' AND Student_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
			}
		}
      }else{
	...
	if($Sname == '' && $Tname == ''){
		...
		$sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
						...
						Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
								Student_Type='$type' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
		*/
		//Modified By Kishan
          if($sessionTypeSel=="Reg"){
              if($type=="select"){
                ...
                $sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                    Session_Type='' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                //$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='' AND Student_Type='$type' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                $sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         From Student natural join Student_Tutor_Assignment join Subject join Tutor 
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                    Session_Type='' AND (Student_Type='$type' OR Tutor_Type='$type') AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }
          }elseif ($sessionTypeSel=="select"){
              ...
              if($type=="select"){
                ...
                $sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         From Student natural join Student_Tutor_Assignment join Subject join Tutor 
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                //$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='' AND Student_Type='$type' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                $sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                    (Student_Type='$type' OR Tutor_Type='$type') AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }
          }
          else{
              if($type=="select"){
                ...
                $sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                    Session_Type='$sessionTypeSel' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                //$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Session_Type='$sessionTypeSel' AND Student_Type='$type' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                $sql = mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         From Student natural join Student_Tutor_Assignment join Subject join Tutor 
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                    Session_Type='$sessionTypeSel' AND (Student_Type='$type' OR Tutor_Type='$type') AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }
          }    
        ...
        /*
         $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                      Tutor.Tutor_Poly_Id='$Tname' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
        */
          //Modified By Kishan
          if($sessionTypeSel=="Reg"){
              if($type=="select"){
                ...
                $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Tutor.Tutor_Poly_Id='$Tname' AND Session_Type='' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                //$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Session_Type='' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Tutor.Tutor_Poly_Id='$Tname' AND Session_Type='' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              ...
              if($type=="select"){
                ...
                $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Tutor.Tutor_Poly_Id='$Tname' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }else{
                //$session1 = mysql_query("SELECT * FROM Student_Tutor_Assignment WHERE Tutor_Poly_Id='$Tname' AND Session_Type='' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
              ...
              if($type=="select"){
                ...
                $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Tutor.Tutor_Poly_Id='$Tname' AND Session_Type='$sessionTypeSel' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                ...
                $sql= mysql_query("SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Tutor.Tutor_Poly_Id='$Tname' AND Session_Type='$sessionTypeSel' AND Tutor_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
      ...
      elseif($Tname == '')
      {
          ...
          $sql = mysql_query(" SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Student_Poly_Id='$Sname' AND Student_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
          */
          //Modified By Kishan
          if($sessionTypeSel=="Reg"){
              if($type=="select"){
                ...
                $sql = mysql_query(" SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Student_Poly_Id='$Sname' AND Session_Type='' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                ...
                $sql = mysql_query(" SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Student_Poly_Id='$Sname' AND Session_Type='' AND Student_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
              }
          }
          elseif ($sessionTypeSel=="select"){
              ...
              if($type=="select"){
                ...
                $sql = mysql_query(" SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Student_Poly_Id='$Sname' AND Session_Type='$sessionTypeSel' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
                ...
                $sql = mysql_query(" SELECT  Tutor_First_Name, Tutor_Last_Name, Student_First_Name, Student_Last_Name,Subject, Session_Time, Date,
                                    Tutor_Current_Time as Tutor_Sign_In,  Student_Current_Time as Student_Sign_In, Tutor_Type , Student_Type
                                                         ...
                                                         WHERE Tutor.Tutor_Poly_ID=Student_Tutor_Assignment.Tutor_Poly_ID  and
                            Subject.Subject_ID=Student_Tutor_Assignment.Subject_ID and 
                                                        Student_Poly_Id='$Sname' AND Session_Type='$sessionTypeSel' AND Student_Type='$type' AND `Date` BETWEEN '$fromedate1' AND '$todate1' Order By $sort");
...
?>
        ...
        <div id="text2">
			...
			&nbsp &nbsp &nbsp <a href="../csv/<?php echo$filename;?>">Download Link </a>
			</div>

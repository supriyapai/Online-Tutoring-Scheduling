...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/savestudent.css" />
</head>
<body>
...
<div class="menu">
	...
	<!--Added By: Parul Joshi Dated : 09/02/2015 Task: Modified the heading of the page to mention its for student -->
	<div id="text2"><p>Please select your save option for Student</p></div>
	...
	<br>
	<br>
	<div id="cancel"><a href="SaveStudentAll.php"><img src="../images/SaveAll.png"  width="145" height="28" border="none"/></a></div>
	<br>
	<div id="reschedule"><a href="SaveStudentType.php"><img src="../images/SaveType.png"  width="145" height="28" border="none"/></a></div>
	<br>
	<div id="mainpage2"><a href="SaveStudentStatus.php"><img src="../images/SaveStatus.png"  width="145" height="28" border="none"/></a></div>
</div>
</center>
</div>    
</body>

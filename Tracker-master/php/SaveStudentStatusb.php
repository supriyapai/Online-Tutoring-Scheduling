...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql= mysql_query("SELECT * FROM Student where Active='$status'") or die (mysql_error());
   ...
   <div class="ex">
   <div class = "back">
<form  action = "SaveStudentStatusb.php"  method = "post">
<table>
<br><br>
    <tr>
        <td>Student Active Status:&nbsp &nbsp &nbsp &nbsp</td>
        <td>
                <select name = "Sname">

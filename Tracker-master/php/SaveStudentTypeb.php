...
function validateForm(){
	...
	if (x==null || x=="---SELECT---"){
		alert("Select Status Of Student");
		return false;
	  }
}
</script>
<script>
function myFunction(){
	document.getElementById("link").class=visible;
}
</script>
</head>
<body>
...
<div class="menu">
	...
	<div id="text2"><p>Save Student Information</p></div>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql= mysql_query("SELECT * FROM Student where Student_Status='$status'") or die (mysql_error());
   ...
   <div class="ex">
   <div class = "back">
<form  action = "SaveStudentTypeb.php"  method = "post">
<table>
<br><br>
    <tr>
        <td><label >Student Category:</label></td>
        <td>
                <select name = "Sname">

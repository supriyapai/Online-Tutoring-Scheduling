...
<div class="menu">
	...
	<!--Added By: Parul Joshi Dated : 09/02/2015 Task: Modified the heading of the page to mention its for tutor -->
	<div id="text2"><p>Please select your save option for Tutor</p></div>
	...
	<div class = "back">
		...
		<br>    
        <div id="cancel">
        <a href="SaveTutorAll.php"><img src="../images/SaveAll.png"  width="145" height="28" border="none"/></a>
	</div>
        <br>
        <div id="reschedule">
        <a href="SaveTutorType.php"><img src="../images/SaveType.png"  width="145" height="28" border="none"/></a>
	</div>
	    <br>
	<div id="mainpage2">
        <a href="SaveTutorStatus.php"><img src="../images/SaveStatus.png"  width="145" height="28" border="none"/></a>
	</div>    
</div>
</div>
</center>

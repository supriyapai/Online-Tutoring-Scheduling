...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql= mysql_query("SELECT * FROM Tutor where Active='$status'") or die (mysql_error());
   ...
   <div class="ex">
   <div class = "back">
<form  action = "SaveTutorStatusb.php"  method = "post">
<table>
<br><br>
    <tr>
        <td>Tutor Active Status:&nbsp &nbsp &nbsp &nbsp</td>
        <td>
                <select name = "Sname">

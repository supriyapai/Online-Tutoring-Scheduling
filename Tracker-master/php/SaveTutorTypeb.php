...
<?php
	...
	if(isset($_POST['submit'])){
		...
		Task - to save the file in csv folder */
		$fp=fopen("../csv/" .$filename,"w");
		$sql= mysql_query("SELECT * FROM Tutor where Tutor_Status='$status'") or die (mysql_error());
   ...
   <div class="ex">
   <div class = "back">
<form  action = "SaveTutorTypeb.php"  method = "post">
<table>
<br><br>
    <tr>
        <td><label >Tutor Category:</label></td>
        <td>
                <select name = "Sname">
...
<br>
<form method="post" action="SaveTutorTypeb.php">

<!-- This page allows you to make selections to generate report based on the student-tutor grouping and 
a common course that tutor and student take --> 
...
function validateForm() {
    ...
    var q = document.forms["myForm"]["Sub"].value;
    if (q == null || q == "---SELECT---") {
...
<div class="menu">
	...
	<div id="text2"><p>Report By Group</p></div>
	<div id="text3"><a href="Adminlogon.php"><p>Sign Out</p></a></div>
    <center>
	<form name = "myForm" action = "ReportCard.php" onsubmit="return validateForm()" method = "post">
...
<table>
	...
	<tr>
	<td> <label for="name">Tutors :</label></td>
	<td>
	...
	<tr>
	<td> <label for="name">Student :</label></td>
	<td>
					<select name = "Sname">
							<option>---SELECT---</option>
					<?php

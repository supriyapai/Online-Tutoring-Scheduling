...
<div class="menu">
	...
	<!-- <div id="text2"><p>Report By Subject</p></div> -->
	<center><div id="text2"><p>Subject Data</p></div></center>
	<div id="text3"><a href="Adminlogon.php"><p>Sign Out</p></a></div>
	<form name = "myForm" action = "ReportCardSubject.php"  onsubmit="return validateForm()" method = "post">
...
<?php
	...
	//Edited By : Parul || Dated:08/20/2015 || Task : to sort all the subjects for the dropdown menu
	$subject1 = mysql_query("SELECT * FROM Subject ORDER BY Subject ");
	while($subject2 = mysql_fetch_array($subject1)){
		$subjectid[] = $subject2[Subject_Id];
	...
	<select name="subject">
		...
		<?php
				for($j=0;$j<$no2; $j++)
				{
						...
						echo "<option value=$subjectid[$j]>$subjectname[$j]</option>";
				}
		?>
	</select>
</td>

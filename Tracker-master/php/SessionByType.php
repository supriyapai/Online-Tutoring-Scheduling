<!-- This page gives you UI for making selections to generate reports by the session type -->
...
<div class="menu">
	...
	<div id="text2"><p>Report By Session Type</p></div>
	<div id="text3"><a href="Adminlogon.php"><p>Sign Out</p></a></div>
	<form name = "myForm" action = "ReportCardType.php"  onsubmit="return validateForm()" method = "post">
	<?php
...
<!-- Modified by:Kishan  Commented the below line for spacing of HTML page -->
</tr>
<tr>
<td> <label for="name">Session Type:</label></td>
<td>
  <select name="sessiontype">
                    <option value="select">---SELECT---</option>
                    <option value="Reg">R/G</option>
...
<tr>
<td> <label for="name">Session Sub-Type:</label></td>
<td>
  <select name="sessionsubtype">
                    <option value="select">---SELECT---</option>
...
<td>
 <select name="sort">
                ...
                <option value="Session_Time">Subject</option>
            </select>
</td>
</tr>
<tr><td></tr></td> <tr><td></tr></td> <tr><td></tr></td> <tr><td></tr></td> 

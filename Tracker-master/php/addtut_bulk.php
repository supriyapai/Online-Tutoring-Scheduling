...
if ($_FILES[csv][size] > 0) {
    ...
    do {
        if ($data[0]) {
            mysql_query("INSERT INTO Tutor (Tutor_Poly_Id,Tutor_First_Name,Tutor_Last_Name,Tutor_MI,Tutor_Email,Tutor_Phone_No, 	Tutor_Hours,Hire_Date,No_Of_Subjects,Subject_Taught_1,Subject_Taught_2,Subject_Taught_3,Subject_Taught_4,Subject_Taught_5,Subject_Taught_6,Class_Status,Graduation_Year,Active,Pay_Rate,Tutor_Status,Lateness,Presence,No_Shows,Cancellations,Reschedules, Block ) VALUES
                (
                    '".addslashes($data[0])."',
                    '".addslashes($data[1])."',
                    '".addslashes($data[2])."',
    ...
    //redirect
    header('Location: addtut_bulk.php?success=1'); die;
...
<link rel="stylesheet" type="text/css" href="../css/addTbulk.css" />
<style>
...
<div class="menu">
	...
	<div id="text2"><p>Upload Tutor Information</p></div>
	<center>

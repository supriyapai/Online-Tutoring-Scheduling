...
<div class="menu">
	...
	<div id="text2"><p>Please select your bulk option for Student</p></div>
	...
	<div class = "back">
		...
		<br>
        <div id="cancel">
        <a href="addstu_bulk.php"><img src="../images/BulkAdd.png"  width="145" height="28" border="none"/></a>
	</div>
        <br>
        <div id="reschedule">
        <a href="bulkupdate.php"><img src="../images/BulkUpdate.png"  width="145" height="28" border="none"/></a>
	</div>
	    <br>
	<div id="mainpage2">
        <a href="delete_allstu.php"><img src="../images/BulkDelete.png"  width="145" height="28" border="none"/></a>

	    
	<!--<div id="polylogo">
        <img src="../images/polylogo.png"  width="106" height="37" border="none"/>
	</div> -->

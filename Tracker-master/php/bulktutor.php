...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/bulktutor.css" />
</head>
<body>
...
<div class="menu">
	...
	<div id="text2"><p>Please select your bulk option for Tutor</p></div>
	...
	<div class = "back">
		...
		<br>
	<div id="cancel">
		<a href="addtut_bulk.php"><img src="../images/BulkAdd.png"  width="145" height="28" border="none"/></a>
	</div>
        <br>
	<div id="reschedule">
		<a href="bulkupdate_T.php"><img src="../images/BulkUpdate.png"  width="145" height="28" border="none"/></a>
	</div>
	    <br>
	<div id="mainpage2">
        <a href="delete_alltut.php"><img src="../images/BulkDelete.png"  width="145" height="28" border="none"/></a>

...
Author: Jordan Brutus
	...
	Filename: delete_allstu.php 
	Supporting Files: deletestu_sql.php, deletestu.css
*/
...
<meta charset="utf-8" />
<title>Delete</title>
<link type="text/css" rel="stylesheet" href="../css/deletestu.css" />
<script type="text/javascript">

//Edited by: Parul Joshi Dated:08/26/2015 Task: Removed the code which displays the students drop down list and studentID
function delete_all(){
	//call php delete file
	$.ajax({
 		type: 'post',
	 	url: '../php/deletestu_sql.php',
	 	cache: false,
...
function warning(){
	var choice=confirm("You are about to DELETE All Students from the database.  Do you want to continue?");
	if (choice===true){
		delete_all();
		alert("All Students Deleted");
		document.getElementById("confirm").innerHTML="<center>All Students Deleted</center>";
}else{
...
<div class="menu">
	...
	<div id="text2">
		<center>
			<p>Delete All Student Information</p>
		</center>
	</div>
	<br>
	<center>
...
<div id="dropdown" style="z-index:800; position: relative;">  
	...
	<div id="deletebut" style="z-index:800; position: relative;">
		<center>
			<button type="submit" name="delete" onclick="warning();" value="Delete"><img src="../images/delete.png"  width="102" height="28" border="none"/></button>
		</center>
	</div>
</div>
</body>

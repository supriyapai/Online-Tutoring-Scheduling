﻿<!--This page will delete a student by their graduation year-->
<?php
...
<script type="text/javascript" src="../js/deleteyear2.js">	
</script>
</head>
...
<div class="menu">
	...
	<div id="text2"><center><p>Delete Student by Graduation Year</p></center></div>
	<br>
	<center>
	...
	<table border="0">
		<tr>
		<center><td><p>Graduation Year:&nbsp; &nbsp;</p></td>
		<form name = "drop_list"  method = "post">
			<td><SELECT NAME="Year_list" id="polyid" style="width: 175px;">

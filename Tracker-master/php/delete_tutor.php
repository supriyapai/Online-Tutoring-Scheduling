...
$tutorDetails1 = mysql_query(" SELECT `Tutor_First_Name`, `Tutor_Last_Name`, `Tutor_Poly_Id` 

FROM Tutor ORDER BY Tutor_Last_Name ");
...
<div class="menu">
	...
	<div id="text2"><center><p>Delete Tutor Information</p></center></div>
	<br>
	<center>
		...
		<center>
			<p>&nbsp; &nbsp;Deleting student or tutor will permanently delete the session allocations for those students or tutors.</p><p>Always <b>SAVE</b> before you <b>DELETE</b>.</p></div>
		</center>
<div id="dropdown" style="z-index:800; position: relative;">
<table border="0">
        <tr>
		<center><td><p>Tutor Name:&nbsp; &nbsp;</p></td>
		<form name = "myForm" action = "<?php $PHP_SELF; ?>" onsubmit="return validateForm2()" method = "post">
		<td>
...
<div id="deletebut" style="z-index:800; position: relative;">
	<center>
		<button type="submit" name="delete" onclick="validateForm2();" value="Delete"><img src="../images/delete.png"  width="102" height="28" border="none"/></button>
	</center>
</div>
</div>

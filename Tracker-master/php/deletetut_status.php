...
<html>
<head>
    <title>Delete Tutors by class status</title>
	<meta charset="utf-8" />
...
if($('#poly_id').val() === '---SELECT---'){ 
	...
	//Edited By: Parul Joshi Dated: 08/24/2015 Task: to rename StudentId to tutorStatus
	var tutorStatus=$('#poly_id').val();
	//call php delete file
	console.log(tutorStatus);
	$.ajax({
 		type: 'post',
	 	url: '../php/delete_status2.php',
	 	data: 'tutorStatus='+tutorStatus,
	 	cache: false,
...
if (choice===true){
	delete_person();
	document.getElementById("success").innerHTML="<center>Tutor(s) Deleted</center>";
}
else{
...
<div class="menu">
	...
	<center>
	<div id="text2"><p>Delete Tutor Information</p></div>
	<div id="success" style="z-index:800; position: relative;"></div>
	<br><br>
